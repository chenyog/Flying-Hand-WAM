...
class FlyingHandInputs(transforms.DataTransformFn):
    ...
    # Pi05 base checkpoints use a 32-dimensional internal action projection.
    # Flying-Hand occupies the first five values and pads the remainder.
    action_dim: int
...
class FlyingHandOutputs(transforms.DataTransformFn):
    """Keep the complete five-dimensional Flying-Hand action."""
